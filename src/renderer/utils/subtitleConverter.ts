...
// 预设样式定义（1080p版本）
// 注意：这些样式适配 1920×1080 分辨率
// 如需 4K (3840×2160)，请使用 subtitle-styles.template.4k.ass 模板
const PRESET_STYLES: Record<string, ASSStyleParams> = {
  '译文字幕 底部': {
    name: '译文字幕 底部',
    fontname: 'Microsoft YaHei',
    fontsize: 90,  // 1080p: 90, 4K: 180
    ...
    shadow: 0,
    alignment: 2,
    marginL: 25,  // 1080p: 25, 4K: 50
    marginR: 25,  // 1080p: 25, 4K: 50
    marginV: 90,  // 1080p: 90, 4K: 180
    encoding: 1,
    lineSpacing: 1
  },
  '双语 原文': {
    name: '双语 原文',
    fontname: 'Microsoft YaHei',  // 统一使用英文名
    fontsize: 70,  // 1080p: 70, 4K: 140
    primaryColour: '&H00FFFFFF',
    ...
    marginL: 25,  // 1080p: 25, 4K: 50
    marginR: 25,  // 1080p: 25, 4K: 50
    marginV: 80,  // 1080p: 80, 4K: 160 (原文在上方)
    encoding: 1,
    lineSpacing: 0
  },
  '双语 译文': {
    ...
    marginL: 25,  // 1080p: 25, 4K: 50
    marginR: 25,  // 1080p: 25, 4K: 50
    marginV: 90,  // 1080p: 90, 4K: 180 (译文在下方)
    encoding: 1,
    lineSpacing: 0
  },
  '译文字幕 顶部': {
    ...
    marginL: 25,
    marginR: 25,
    marginV: 50,  // 1080p: 50, 4K: 100 (顶部边距)
    encoding: 1,
    lineSpacing: 1
  },
  '注释 底部': {
    name: '注释 底部',
    fontname: 'Microsoft YaHei',
    fontsize: 65,  // 1080p: 65, 4K: 130 (较小字体)
    primaryColour: '&H00FFFFFF',
    secondaryColour: '&H00535353',
    outlineColour: '&H00000000',
    backColour: '&H00000000',

...
| 分辨率 | PlayResX | PlayResY | 说明 |
|--------|----------|----------|------|
| **1080p** | 1920 | 1080 | ✅ 当前使用（推荐） |
| 720p | 1280 | 720 | 适用于中等分辨率视频 |
| 4K | 3840 | 2160 | 适用于超高清视频 |

**重要提示：**
- 分辨率会影响字号和边距的实际显示大小
- 1080p 下字号 90 ≈ 720p 下字号 60
- 修改分辨率后需同步调整字号
...
**公式：** 新字号 = 旧字号 × (新分辨率 ÷ 1080)

| 目标分辨率 | 计算 | 字号 90 → |
|-----------|------|-----------|
| 720p | 90 × (720÷1080) | **60** |
| 1440p | 90 × (1440÷1080) | **120** |
| 4K (2160p) | 90 × (2160÷1080) | **180** |
...
[V4+ Styles]
Style: 译文字幕 底部,Microsoft YaHei,60,...  ← 90→60
```
